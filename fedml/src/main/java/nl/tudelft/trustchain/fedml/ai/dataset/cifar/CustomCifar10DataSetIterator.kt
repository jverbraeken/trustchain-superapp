...
class CustomCifar10DataSetIterator(
    ...
    CustomCifar10Fetcher().getRecordReader(seed, null, dataSetType, null, iteratorConfiguration.distribution, if (dataSetType == CustomDataSetType.TEST) iteratorConfiguration.maxTestSamples.value else Integer.MAX_VALUE),
