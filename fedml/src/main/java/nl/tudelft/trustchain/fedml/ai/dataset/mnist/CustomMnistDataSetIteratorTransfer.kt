...
class CustomMnistDataSetIteratorTransfer(
    ...
    companion object {
        fun create(
            ...
            baseDirectory: File,
            behavior: Behaviors
        ): CustomMnistDataSetIteratorTransfer {
            return CustomMnistDataSetIteratorTransfer(iteratorConfiguration, seed, dataSetType, behavior)
        }
    }
}
