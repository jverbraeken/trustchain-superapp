...
public class NDArrayStrings2 {
    ...
    /**
     * The default number of elements for printing INDArrays (via NDArrayStrings2 or INDArray.toString)
     */
    ...
    public NDArrayStrings2() {
        this(",", 4);
    }

    public NDArrayStrings2(String colSep) {
        this(colSep, 4);
    }
     ...
     * @param precision
     */
    public NDArrayStrings2(int precision) {
        this(",", precision);
    }

    public NDArrayStrings2(long maxElements, int precision) {
        this(",", precision);
        this.localMaxPrintElements = maxElements;
    }

    public NDArrayStrings2(long maxElements) {
        this();
        this.localMaxPrintElements = maxElements;
    }

    public NDArrayStrings2(long maxElements, boolean forceSummarize, int precision) {
        this(",", precision);
        if(forceSummarize)
    ...
    public NDArrayStrings2(boolean forceSummarize, int precision) {
        this(",", precision);
        if(forceSummarize)
            localMaxPrintElements = 0;
    }
    ...
    public NDArrayStrings2(boolean forceSummarize) {
        this(",", 4);
        if(forceSummarize)
            localMaxPrintElements = 0;
    }
     ...
     */
    public NDArrayStrings2(String colSep, int precision) {
        this.colSep = colSep;
     ...
     * @param decFormat
     */
    public NDArrayStrings2(String colSep, String decFormat) {
        this.colSep = colSep;
