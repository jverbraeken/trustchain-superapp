...
private const val TRAINING_FILES_FILENAME = "train-images-idx3-ubyte.gz"
private const val TRAINING_FILES_FILENAME_UNZIPPED = "train-images-idx3-ubyte"
private const val TRAINING_FILE_LABELS_FILENAME = "train-labels-idx1-ubyte.gz"
private const val TRAINING_FILE_LABELS_FILENAME_UNZIPPED = "train-labels-idx1-ubyte"

class CustomMnistDataFetcherTransfer(
    ...
    @Transient
    private var man: CustomMnistManagerTransfer
    ...
    init {
        ...
        try {
            man = CustomMnistManagerTransfer(
                images,
                labels,
                maxExamples,
    ...
    private fun mnistExists(): Boolean {
        val mnistRoot = DL4JResources.getDirectory(ResourceType.DATASET, "EMNIST").absolutePath
