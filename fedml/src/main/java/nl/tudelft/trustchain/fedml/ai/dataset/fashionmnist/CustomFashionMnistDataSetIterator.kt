...
class CustomFashionMnistDataSetIterator(
    ...
    companion object {
        fun create(
            ...
            behavior: Behaviors,
            transfer: Boolean
        ): CustomFashionMnistDataSetIterator {
            return CustomFashionMnistDataSetIterator(iteratorConfiguration, seed, dataSetType, behavior, transfer)
        }
    }
}
