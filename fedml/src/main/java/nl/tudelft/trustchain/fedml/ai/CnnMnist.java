...
public class CnnMnist {
    ...
    private static final String TRAINING_IMAGES_ARCHIVE = "train-images-idx3-ubyte.bin";
    private static final String TRAINING_LABELS_ARCHIVE = "train-labels-idx1-ubyte.bin";
    private static final String TEST_IMAGES_ARCHIVE = "t10k-images-idx3-ubyte.bin";
    private static final String TEST_LABELS_ARCHIVE = "t10k-labels-idx1-ubyte.bin";
    ...
    public static void main(File baseDirectory) {
        logger.info(
        ...
        MnistDataset dataset = MnistDataset.create(0, TRAINING_IMAGES_ARCHIVE, TRAINING_LABELS_ARCHIVE,
            TEST_IMAGES_ARCHIVE, TEST_LABELS_ARCHIVE, baseDirectory);
